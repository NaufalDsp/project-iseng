...
export default function HomePage() {
  ...
  const handleNameSubmit = async (name: string) => {
    ...
    try {
      ...
      alert(`Gagal menyimpan username. Cek koneksi atau server (${msg}).`);
      return;
    }
  ...
  return (
    <>
      <BlossomBackground enabled={!!username} />
          ...
          <main className="relative bg-white/70 backdrop-blur rounded-none sm:rounded-2xl p-4 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6">
              ...
              <div>
                ...
                <GratitudeWall username={username} />
              </div>
            </div>
            {showConfirm && (
              <div
